...
static char UIViewKeyboardWillRecedeBlock;
...
@property (nonatomic) DAKeyboardWillRecedeBlock keyboardWillRecedeBlock;
...
- (void)addKeyboardRecedingWithActionHandler:(DAKeyboardWillRecedeBlock)actionHandler
{
  self.keyboardWillRecedeBlock = actionHandler;
}
...
- (void)removeKeyboardControl
{
  ...
  self.keyboardWillRecedeBlock = nil;
...
- (void)panGestureDidChange:(UIPanGestureRecognizer *)gesture
{
  ...
  switch (gesture.state)
  {
    ...
    case UIGestureRecognizerStateCancelled:
    {
      ...
      // JM: If we're going to recede and an actionHandler was supplied, then run it.
      if ((shouldRecede) && (self.keyboardWillRecedeBlock)) {
...
- (DAKeyboardWillRecedeBlock)keyboardWillRecedeBlock
{
  return objc_getAssociatedObject(self,
                                  &UIViewKeyboardWillRecedeBlock);
}

- (void)setKeyboardWillRecedeBlock:(DAKeyboardWillRecedeBlock)keyboardWillRecedeBlock
{
  [self willChangeValueForKey:@"keyboardWillRecedeBlock"];
  objc_setAssociatedObject(self,
                           &UIViewKeyboardWillRecedeBlock,
                           keyboardWillRecedeBlock,
                           OBJC_ASSOCIATION_COPY);
  [self didChangeValueForKey:@"keyboardWillRecedeBlock"];
}
